    ...
    html! {
        <div class="translation-panel">
            ...
            {match &*props.app_state {
                AppState::Idle => html! {
                    <div class="translation-idle">
                        <div class="idle-icon">{"📤"}</div>
                        <div class="idle-content">
                            <h3>{"等待视频上传"}</h3>
                            <p class="section-description">{"请先在左侧上传视频文件，然后选择源语言和目标语言进行翻译"}</p>
                        </div>
                    </div>
                },
                AppState::Uploading => html! {
                    <div class="translation-waiting">
                        <div class="waiting-icon">{"⏳"}</div>
                        <div class="waiting-content">
                            <h3>{"正在上传视频"}</h3>
                            <p class="section-description">{"视频文件正在上传中，请稍候..."}</p>
                        </div>
                    </div>
                },
                AppState::Ready(path) => html! {
                    <div class="translation-controls">
                        <div class="video-ready-info">
                            <div class="ready-icon">{"✅"}</div>
                            <div class="ready-content">
                                <h3>{"视频已准备就绪"}</h3>
                                <p class="video-path">{format!("文件: {}", path)}</p>
                            </div>
                        </div>
                        ...
                        <div class="translation-settings">
                            ...
                            <div class="language-selection">
                                <div class="language-group">
                                    <label for="trans-source-language">
                                        <span class="label-icon">{"🗣️"}</span>
                                        {"源语言"}
                                    </label>
                                    <select id="trans-source-language">
                                ...
                                <div class="language-group">
                                    <label for="trans-target-language">
                                        <span class="label-icon">{"🎯"}</span>
                                        {"目标语言"}
                                    </label>
                                    <select id="trans-target-language">
                                        {for SUPPORTED_LANGUAGES.iter().map(|(code, name)| {
                                            html! {
                        ...
                        <div class="translation-actions">
                            <button class="btn btn-primary btn-large" onclick={on_translate}>
                ...
                AppState::Translating(_) => html! {
                    <div class="translation-progress">
                        <div class="progress-content">
                            ...
                            <h3>{"正在翻译视频"}</h3>
                            <p class="section-description">{"AI 正在处理您的视频，这可能需要几分钟时间，请耐心等待..."}</p>
                    ...
                    <div class="translation-result">
                        ...
                        <div class="result-info">
                            <div class="output-path">
                                ...
                                <span class="path-value">{output_path}</span>
                            </div>
                        </div>
                ...
                _ => html! {
                    <div class="translation-unknown">
                        <div class="unknown-icon">{"❓"}</div>
                        <div class="unknown-content">
                            <h3>{"未知状态"}</h3>
                            <p class="section-description">{"当前状态不支持翻译操作"}</p>
                        </div>
                    </div>
